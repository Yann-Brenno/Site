<?php
	...
	if(!empty($_SESSION['usuarioNiveisAcessoId'] == '3' OR $_SESSION['usuarioNiveisAcessoId'] == '4' OR $_SESSION['usuarioNiveisAcessoId'] == '6' AND $_SESSION['id_usuario'])){
...
<html lang="pt-br">
  ...
  <body>
                   ...
                   *************pagina de mecanico em desenvolvimento******************
